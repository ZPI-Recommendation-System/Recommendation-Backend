...
export class CreateTables1670434726126 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "model_entity" ("id" character varying NOT NULL, "name" character varying NOT NULL, "model" character varying NOT NULL, "type" character varying, "producentCode" character varying, "batterySizeWH" double precision, "batterySizeMAH" double precision, "batteryTime" double precision, "color" character varying, "width" double precision, "length" double precision, "depth" double precision, "weight" double precision, "ramAmount" double precision NOT NULL, "ramFrequency" integer, "ramNumberOfSlots" integer, "ramNumberOfFreeSlots" integer, "ramType" character varying, "ramMaxAmount" integer, "driveStorage" integer NOT NULL, "driveType" character varying, "hddSpeed" integer, "estimatedScore" integer, "estimatedPopularity" integer, "price" double precision NOT NULL, "priceSource" character varying NOT NULL DEFAULT 'unknown', "processorId" integer, "screenId" integer, "graphicsId" integer, CONSTRAINT "PK_042b93cee74ff493db04129d4f5" PRIMARY KEY ("id"))`);
