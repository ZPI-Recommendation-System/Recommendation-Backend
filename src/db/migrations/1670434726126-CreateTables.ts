...
export class CreateTables1670434726126 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO user_entity (username, email, password, role, name, surname) VALUES('${process.env.ADMIN_USERNAME}', '${process.env.ADMIN_EMAIL}', '${bcrypt.hashSync(process.env.ADMIN_PASSWORD, 10)}', '${process.env.ADMIN_ROLE}', '${process.env.ADMIN_NAME}', '${process.env.ADMIN_SURNAME}')`);
